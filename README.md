...
This action currently supports CoilSnake's [346cfc7](https://github.com/pk-hack/CoilSnake/commit/346cfc753644bc3703b6fc4eaa0a5d6bdcb9bb4a) and CCScript's [80a03df](https://github.com/pk-hack/ccscript_legacy/commit/80a03df13cfe9bd3aab5f0d7d34aad7dd2c7bae0) builds.
...
| `expanding-option` | The target size of the ROM file will expand to: [32MBit / 48MBit].<br>If you don't want to expand the ROM file you can skip this option. | No | No Expansion |
